...
function SaikuTableRenderer(a,b){this._data=a;this._options=_.extend({},SaikuRendererOptions,b)}function getAxisLevelsName(a,b){for(var c=a.query.queryModel.axes[b].hierarchies,d=c.length,e=[],f=0;f<d;f++)for(var h in c[f].levels)c[f].levels.hasOwnProperty(h)&&(Settings.COLUMN_TITLE_TABLE_USE_LEVEL_CAPTION_NAME?e.push(c[f].levels[h].caption):e.push(h));return e}function getAxisSize(a,b){for(var c=a.query.queryModel.axes[b].hierarchies,d=c.length,e=0,f=0;f<d;f++)e+=_.size(c[f].levels);return e}
...
Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type)var N=getAxisLevelsName(a,COLUMNS),D=getDomColumnsLevelsName(this._options.htmlObject),T=getAxisSize(a,ROWS),P=0,N=N.length===D.length?D:_.intersection(D,N);for(var t=0;t<d.length;t++)x[d[t]]=[],I[d[t]]=[];cleanupTotals(d,w);if(w[COLUMNS])for(t=0;t<w[COLUMNS].length;t++)I[COLUMNS][t]=0,x[COLUMNS][t]=w[COLUMNS][t][I[COLUMNS][t]].width;for(var v=0,Q=l.length;v<Q;v++){var O=v-a.topOffset;g=1;var R=D=s=m=!1;if(w[ROWS])for(t=0;t<
w[ROWS].length;t++)I[ROWS][t]=0,x[ROWS][t]=w[ROWS][t][I[ROWS][t]].width;rowWithOnlyEmptyCells=!0;var d="\x3ctr\x3e",q=null;0===v&&(d="\x3cthead\x3e"+d);"object"===typeof this._options.htmlObject&&Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&P<N.length&&(d+='\x3cth class\x3d"row_header" style\x3d"text-align: right;" colspan\x3d"'+T+'" title\x3d"'+N[P]+'"\x3e'+(A?"\x3cdiv\x3e"+N[P]+"\x3c/div\x3e":N[P])+"\x3c/th\x3e",P+=1);for(var u=0,S=l[v].length;u<S;u++)if(t=u-a.leftOffset,
q=e[v][u],"COLUMN_HEADER"===q.type&&(D=!0),"COLUMN_HEADER"===q.type&&"null"===q.value&&(null==n||u<n))Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0!==M&&"MDX"!==a.query.type||(d+='\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e');else if("COLUMN_HEADER"===q.type){null==n&&(n=u);l[v].length==u+1?s=!0:p=e[v][u+1];if(s)"null"==q.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+
g+'" title\x3d"'+q.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e");else{var t=1<u&&1<v&&!m&&u>n?e[v-1][u+1].value!=e[v-1][u].value||e[v-1][u+1].properties.uniquename!=e[v-1][u].properties.uniquename:!1,G=999<g?!0:!1;q.value!=p.value||nextParentsDiffer(e,v,u)||m||t||G?("null"==q.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+
(0==g?1:g)+'" title\x3d"'+q.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e"),g=1):g++}w[ROWS]&&(d+=genTotalHeaderCells(u-a.leftOffset+1,v+1,x[ROWS],I[ROWS],w[ROWS],A))}else if("ROW_HEADER"===q.type&&"null"===q.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';else if("ROW_HEADER"===q.type){B==u?m=!0:p=e[v][u+1];var G=e[v-1],t=e[v+1],G=!R&&!m&&(0==u||!topParentsDiffer(e,v,u))&&q.value===G[u].value,R=!G,F=!1;if(Settings.ALLOW_TABLE_DATA_COLLAPSE)if(0<
v&&v<Q-1){if(null==w[ROWS]||u<=S-w[ROWS].length-1){var y=!0;w[COLUMNS]&&0<=O&&u<=isNextTotalsRow(O+1,x,I,w,A)&&(F=!0,y=!1);if(y&&t[u].value==q.value)if(0<u)for(y=0;y<u;y++)if(t[y].value==e[v][y].value)F=!0;else{F=!1;break}else F=!0}}else 0<v&&v==Q-1&&w[COLUMNS]&&0<=O&&u<=isNextTotalsRow(O+1,x,I,w,A)&&(F=!0);t=G?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+(F&&Settings.ALLOW_TABLE_DATA_COLLAPSE?'\x3cspan class\x3d"expander expanded"\x3e\x26#9660;\x3c/span\x3e':"")+q.value+
"\x3c/div\x3e";A||(t=G?"\x26nbsp;":q.value);G=G?"row_null":"row";F=0;if(!m&&("undefined"==typeof p||"null"===p.value)){var F=1,y=q.properties.dimension,J=q.properties.level,y=y in r?r[y].length-r[y].indexOf(J):1,J=u+1;for(;F<y&&J<=B+1&&"null"!==e[v][J];J++)F=J-u;u=u+F-1}d+='\x3cth class\x3d"'+G+'" '+(0<F?' colspan\x3d"'+F+'"':"")+"\x3e"+t+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===q.type){G=[];if(_.contains(h,q.value)){for(t=0;t<h.length;t++)h[t]===q.value&&G.push(t);G.push(u)}d+='\x3cth class\x3d"row_header"\x3e'+
(A?"\x3cdiv\x3e"+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e";h.push(q.value);k.push({name:q.value,hierName:function(a){a=a.properties.hierarchy;return a.replace(/[\[\]]/gi,"").split(".")[1]?a.replace(/[\[\]]/gi,"").split(".")[1]:a.replace(/[\[\]]/gi,"").split(".")[0]}(q)+"/"+q.value});m=!0;B=u;q.properties.hasOwnProperty("dimension")&&(y=q.properties.dimension,y in r||(r[y]=[]),r[y].push(q.properties.level));if(0<G.length){F=0;d="\x3ctr\x3e";0===v&&(d="\x3cthead\x3e"+d);for(t=0;t<k.length;t++)G[F]===
t?(f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[t].hierName+"\x3c/div\x3e":k[t].hierName)+"\x3c/th\x3e",F+=1):f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[t].name+"\x3c/div\x3e":k[t].name)+"\x3c/th\x3e";d+=f}}else"DATA_CELL"===q.type&&(E=!0,G="",y=_.isEmpty(q.value)?Settings.EMPTY_VALUE_CHARACTER:q.value,F="",q.properties.hasOwnProperty("image")&&(y=q.properties.hasOwnProperty("image_height")?" height\x3d'"+q.properties.image_height+"'":"",J=q.properties.hasOwnProperty("image_width")?
" width\x3d'"+q.properties.image_width+"'":"",y="\x3cimg "+y+" "+J+" style\x3d'padding-left: 5px' src\x3d'"+q.properties.image+"' border\x3d'0'\x3e"),"-"!==y&&""!==y&&q.properties.hasOwnProperty("style")&&(G=" style\x3d'background-color: "+q.properties.style+"' "),q.properties.hasOwnProperty("link")&&(y="\x3ca target\x3d'__blank' href\x3d'"+q.properties.link+"'\x3e"+y+"\x3c/a\x3e"),q.properties.hasOwnProperty("arrow")&&(F="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+
q.properties.arrow+".gif' border\x3d'0'\x3e"),"-"!==y&&""!==y&&(rowWithOnlyEmptyCells=!1),d+='\x3ctd class\x3d"data" '+G+"\x3e"+(A?'\x3cdiv class\x3d"datadiv" alt\x3d"'+q.properties.raw+'" rel\x3d"'+q.properties.position+'"\x3e':"")+y+F+(A?"\x3c/div\x3e":"")+"\x3c/td\x3e",w[ROWS]&&(d+=genTotalDataCells(t+1,O,x[ROWS],I[ROWS],w,A)));d+="\x3c/tr\x3e";b.hideEmpty&&"DATA_CELL"===q.type&&rowWithOnlyEmptyCells&&(d="");g="";w[COLUMNS]&&0<=O&&(g+=genTotalHeaderRowCells(O+1,x,I,w,A));E&&C?v<=C?(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",
H=!0),c+=d,0<g.length&&(c+=g)):(K.push(d),0<g.length&&K.push(g)):(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=K,b.hasBatchResult=0<K.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
...
this.workspace.query.helper.includeMeasure(c);this.workspace.sync_query();this.workspace.query.run();a.preventDefault();return!1}},measure_dialog:function(a,b){(new CalculatedMemberModal({workspace:this.workspace,measure:null})).render().open()}}),Toolbar=Backbone.View.extend({tagName:"div",buttons:!1,events:{"click a":"call","click #logo":"site"},template:function(){var a=Saiku.URLParams.paramsURI();Saiku.URLParams.contains({hide_workspace_icons:a.hide_workspace_icons})&&(this.buttons=a.hide_workspace_icons);
...
Saiku.events.trigger("toolbar:render",{toolbar:this});return this},call:function(a){var b=$(a.target).attr("href").replace("#","");if(this[b])this[b](a);a.preventDefault()},new_query:function(){"undefined"!=typeof ga&&ga("send","event","MainToolbar","New Query");var a=new Workspace;Saiku.tabs.add(a);Saiku.events.trigger("toolbar:new_query",this,a);return!1},open_query:function(){var a=_.find(Saiku.tabs._tabs,function(a){return a.content instanceof OpenQuery});a?a.select():Saiku.tabs.add(new OpenQuery);
...
this.members_search_server=this.available_members.length>=this.members_limit||0==this.available_members.length;c.show_unique_option=!1;$(this.el).find(".options #show_unique").attr("checked",!1);var d=this.workspace.query.helper.getCalculatedMembers();if(0<d.length)for(var e=this.get_calcmembers(),f=e.length,h=0;h<f;h++){var k=!1;d&&0<d.length&&_.each(d,function(a){a.uniqueName===e[h].uniqueName&&(k=!0)});this.available_members.push({obj:e[h],calc:k})}$(this.el).find(".items_size").text(this.available_members.length);
...
calc:d})}),this.selection_type=d.levels[f].selection?d.levels[f].selection.type:"INCLUSION");for(var l=[],d=0,f=this.selected_members.length;d<f;d++)l.push(this.selected_members[d].obj.caption);0==$(this.el).find(".used_selections .selection_options li.option_value").length&&(d=$(this.el).find(".used_selections .selection_options"),d.empty(),f=_.template($("#template-selections-options").html())({options:this.selected_members}),$(d).html(f));f=c.workspace.query.model.queryModel.details.measures;for(d=
0;d<f.length;d++)$(this.el).find("#div-totals-container").append(_.template($("#template-selections-totals").html())({measure:f[d]}));$("#per_metrics_totals_checkbox").change(function(){$(this).is(":checked")?($(".per_metrics_container").show(),$(".all_metrics_container").hide()):($(".per_metrics_container").hide(),$(".all_metrics_container").show())});this.available_members=_.select(this.available_members,function(a){return-1===l.indexOf(a.obj?a.obj.caption:a.caption)});0<this.available_members.length&&
...
!0);$(b).parents(".selection_options").find("li.all_options input").prop("checked",!0)});$(c.el).find(".selection_options li.ui-selected").removeClass("ui-selected")}});$(this.el).find(".filterbox").autocomplete({minLength:1,delay:200,appendTo:".autocomplete",source:function(a,b){var d=0==c.show_unique_option?"caption":"name",e=$.map(c.available_members,function(b){var e=b.obj;void 0===e?(e=b,b=e[d]):b=e.caption;if(-1<b.toLowerCase().indexOf(a.term.toLowerCase()))return{label:0==c.show_unique_option?
e.caption:e.uniqueName,value:0==c.show_unique_option?e.uniqueName:e.caption}});b(e)},select:function(a,b){encodeURIComponent(b.item.value);var d=b.item.label,e=0==c.show_unique_option?b.item.value:b.item.label,f=0==c.show_unique_option?b.item.label:b.item.value;$(c.el).find('.available_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();$(c.el).find('.used_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();d='\x3cli class\x3d"option_value"\x3e\x3cinput type\x3d"checkbox" class\x3d"check_option" value\x3d"'+
...
use_result_action:function(){this.use_result_option=!this.use_result_option;this.get_members()},save:function(){this.query.updatedSelectionFromModal=!0;var a=this,b=$("\x3cdiv\x3eSaving...\x3c/div\x3e");$(this.el).find(".dialog_body").children().hide();$(this.el).find(".dialog_body").prepend(b);var c=decodeURIComponent(a.member.hierarchy),d=decodeURIComponent(a.member.level),b=a.workspace.query.helper.getHierarchy(c),e=[];0!==$(this.el).find(".used_selections input").length&&(a.workspace.query.helper.removeAllLevelCalculatedMember(c),
$(this.el).find(".used_selections .option_value input").each(function(b,f){var h=$(f).val();if($(f).hasClass("cmember")){var k=$(f).attr("label");a.workspace.toolbar.group_parents();a.workspace.query.helper.includeLevelCalculatedMember(a.axis,c,d,decodeURIComponent(h),0);e.push({uniqueName:decodeURIComponent(h),caption:decodeURIComponent(k),type:"calculatedmember"})}else k=$(f).attr("label"),e.push({uniqueName:decodeURIComponent(h),caption:decodeURIComponent(k)})}));var f=$("#parameter").val();if(b&&
b.levels.hasOwnProperty(d)){var h=[];if($("#per_metrics_totals_checkbox").is(":checked"))$(".show_totals_select").each(function(){h.push($(this).val())});else for(var k=a.workspace.query.model.queryModel.details.measures,l=0;l<k.length;l++)h.push($("#all_measures_select").val());b.levels[d].aggregators=h;k=$(a.el).find("input.selection_type:checked").val();b.levels[d].selection={type:k?k:"INCLUSION",members:e};Settings.ALLOW_PARAMETERS&&f&&(b.levels[d].selection.parameterName=f,a.workspace.query.helper.model())}this.finished()},
finished:function(){$("#filter_selections").remove();this.available_members=null;$(this.el).find(".filterbox").autocomplete("destroy").remove();$(this.el).dialog("destroy");$(this.el).remove();this.query.run()}}),DrillthroughModal=Modal.extend({type:"drillthrough",buttons:[{text:"Ok",method:"ok"},{text:"Cancel",method:"close"}],events:{"click .collapsed":"select","click .expand":"select","click .folder_collapsed":"select","click .folder_expanded":"select","click .dialog_footer a":"call","click .parent_dimension input":"select_dimension",
"click .measure_tree input":"select_measure","click input.all_measures":"select_all_measures","click input.all_dimensions":"select_all_dimensions"},allMeasures:!1,templateContent:function(){return $("#template-drillthrough").html()},initialize:function(a){_.extend(this,a);this.options.title=a.title;this.query=a.workspace.query;this.position=a.position;this.action=a.action;Saiku.ui.unblock();_.bindAll(this,"ok","drilled","template");this.render();$(this.el).find(".dialog_body").html(_.template(this.templateContent())(this));
...
$(this.workspace.table.el).empty();this.workspace.adjust();this.post_mdx_transform()},post_mdx_transform:function(){var a=this;"MDX"!==this.workspace.query.model.type&&(this.workspace.query.model.queryModel={},this.workspace.query.model.type="MDX",this.workspace.query.setProperty("saiku.olap.result.formatter","flat"),a.workspace.query.helper.model().parameters={});var b=this.workspace.query.model.mdx;a.editor&&(a.editor.setValue(b,0),a.editor.clearSelection(),a.editor.focus());$(a.el).find(".group_parents").removeClass("on");
if(Settings.ALLOW_PARAMETERS){var c=function(){var b=a.editor.getValue(),c=[];if(b)for(var f=0,h=b.length;f<h-1;f++)if("$"===b[f]&&"{"===b[f+1]){for(var k="",l=!1,f=f+2;f<h;f++)if("}"!==b[f])k+=b[f];else{l=!0;f++;break}l&&k&&0<k.length&&c.push(k)}var g=a.workspace.query.helper.model().parameters,m={};_.each(c,function(a){m[a]=g[a]?g[a]:""});a.workspace.query.helper.model().parameters=m;a.workspace.update_parameters()},b=function(){_.delay(c,1E3)};a.editor&&(a.editor.getSession().off("change",b),a.editor.getSession().on("change",
b));a.workspace.update_parameters()}},run_mdx:function(a){100<$(this.workspace.el).find(".mdx_input").height()&&$(this.workspace.el).find(".mdx_input").height(100);this.editor.resize();a=this.editor.getValue();this.workspace.query.model.mdx=a;this.workspace.query.run(!0)},explain_query:function(a){this.workspace.query.action.gett("/explain",{success:function(a,c){var d="\x3ctextarea style\x3d'width: "+($("body").width()-165)+"px;height:"+($("body").height()-175)+"px;'\x3e",d=null!==c&&null!==c.error?
...
function(e){0<e.cubes.length&&_.each(e.cubes,function(f){if("undefined"===typeof f.visible||f.visible){var h=""===e.name||null===e.name?"null":e.name;f=""===f.caption||null===f.caption?f.name:f.caption;a.schema===h&&a.cube===f&&(b.selected_cube=c.name+"/"+d.name+"/"+h+"/"+f,b.isUrlCubeNavigation=!0,b.paramsURI=a,_.delay(b.new_query,1E3))}})})})})},create_new_query:function(a){a.query&&(a.query.destroy(),a.query.clear(),a.query.name&&(a.query.name=void 0,a.update_caption(!0)),a.query.name=void 0);
a.clear();a.processing.hide();Saiku.session.trigger("workspace:clear",{workspace:a});a.selected_cube=$(a.el).find(".cubes").val()?$(a.el).find(".cubes").val():a.selected_cube;if(!a.selected_cube)return $(a.el).find(".calculated_measures, .addMeasure").hide(),$(a.el).find(".dimension_tree").html(""),$(a.el).find(".measure_tree").html(""),!1;a.metadata=Saiku.session.sessionworkspace.cube[a.selected_cube];for(var b=a.selected_cube.split("/"),c=b[3],d=4,e=b.length;d<e;d++)c+="/"+b[d];Saiku.events.trigger("workspace:new_query",
this,{view:this,cube:c});this.query=new Query({cube:{connection:b[0],catalog:b[1],schema:"null"==b[2]?"":b[2],name:decodeURIComponent(c)}},{workspace:a});this.processedParamsURI||(b=Saiku.URLParams.paramsURI(),c=function(a,b){var c=this.query.helper.getAxis(a),d=b.charAt(0),e=b.charAt(b.length-1),m=[],n=[],s="";if("("===d&&")"===e)if(b=Saiku.trimFirstLastChar(b),-1!==b.indexOf("],")){for(var n=b.split("],")[0].split("].["),d=_.last(n),n=_.first(n,2<n.length?2:1),e=b.split("],")[1].trim(),p=0,B=n.length;p<
B;p++)s+="["+Saiku.removeBrackets(n[p])+"].";s=Saiku.trimFirstLastChar(s,"last");this.query.helper.includeLevel(a,s,d,"-1")}else e=b;else e=b;m.push(e);this.query.helper.removeFilter(c,"Generic");c.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:m})}.bind(this),Saiku.URLParams.contains({default_mdx_filter_rows:b.default_mdx_filter_rows})&&c("ROWS",b.default_mdx_filter_rows),Saiku.URLParams.contains({default_mdx_filter_columns:b.default_mdx_filter_columns})&&c("COLUMNS",
b.default_mdx_filter_columns),Saiku.URLParams.contains({default_mdx_filter:b.default_mdx_filter})&&c("FILTER",b.default_mdx_filter),this.processedParamsURI=!0);a.query=this.query;a.query.save({},{data:{json:JSON.stringify(this.query.model)},async:!1});a.init_query()},extractDefaultFilters:function(a){var b=[],c,d;for(d in a)if(-1<d.indexOf("default_filter_")){var e=d.replace("default_filter_","");c=a[d];b.push({filtername:e,filtervalue:c})}return b},new_query:function(){this.query?Settings.QUERY_OVERWRITE_WARNING?
(new WarningModal({title:"New Query",message:"You are about to clear your existing query",okay:this.create_new_query,okayobj:this})).render().open():this.create_new_query(this):this.create_new_query(this)},init_query:function(a){var b=this;try{var c=this.query.model.properties?this.query.model.properties:{},d="RENDER_MODE"in Settings?Settings.RENDER_MODE:"saiku.ui.render.mode"in c?c["saiku.ui.render.mode"]:null,e="RENDER_TYPE"in Settings?Settings.RENDER_TYPE:"saiku.ui.render.type"in c?c["saiku.ui.render.type"]:
null;"table"==Settings.MODE?d="table":"chart"==Settings.MODE?d="chart":"map"==Settings.MODE&&(d="map");"undefined"!=typeof d&&null!==d&&this.querytoolbar.switch_render(d);"chart"==d?(!Settings.MODE||"chart"!==Settings.MODE||"map_heat"!==e&&"map_geo"!==e&&"map_marker"!==e||(this.query.setProperty("saiku.ui.render.mode","chart"),e="stackedBar"),$(this.chart.el).find(".canvas_wrapper").hide(),this.chart.renderer.switch_chart(e),$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').parent().siblings().find(".on").removeClass("on"),
$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').addClass("on"),this.set_class_charteditor()):"table"==d&&e in this.querytoolbar?(this.querytoolbar.render_mode="table",this.querytoolbar.spark_mode=e,$(this.querytoolbar.el).find("ul.table a."+e).addClass("on")):"map"===d&&(this.querytoolbar.$el.find("ul.chart \x3e li").find("a").removeClass("on"),this.querytoolbar.$el.find('ul.chart [href\x3d"#'+d+'"]').addClass("on"))}catch(f){Saiku.error(this.cid,f)}"table"==Settings.MODE&&this.query?
this.query.run(!0):("MDX"==this.query.model.type?(this.query.setProperty("saiku.olap.result.formatter","flat"),$(this.el).find(".sidebar").hasClass("hide")||this.toggle_sidebar(),$(this.el).find(".workspace_fields").addClass("hide"),this.toolbar.switch_to_mdx()):($(this.el).find(".workspace_editor").removeClass("hide").show(),$(this.el).find(".workspace_fields").removeClass("disabled").removeClass("hide"),$(this.el).find(".workspace_editor .mdx_input").addClass("hide"),$(this.el).find(".workspace_editor .editor_info").addClass("hide"),
$(this.toolbar.el).find(".auto, .toggle_fields, .query_scenario, .buckets, .non_empty, .swap_axis, .mdx, .switch_to_mdx, .zoom_mode, .drillacross").parent().show(),$(this.el).find(".run").attr("href","#run_query")),this.adjust(),this.switch_view_state(this.viewState,!0),$(this.el).find(".sidebar").hasClass("hide")||"chart"!=Settings.MODE&&"table"!=Settings.MODE&&"map"!=Settings.MODE&&"view"!=Settings.MODE&&!this.isReadOnly||this.toggle_sidebar(),"view"==Settings.MODE&&this.query||this.isReadOnly?
(this.query.run(!0),void 0===this.selected_cube&&(c=this.query.model.cube.schema,this.selected_cube=this.query.model.cube.connection+"/"+this.query.model.cube.catalog+"/"+(""===c||null===c?"null":c)+"/"+encodeURIComponent(this.query.model.cube.name),$(this.el).find(".cubes").val(this.selected_cube))):(void 0===this.selected_cube&&(c=this.query.model.cube.schema,this.selected_cube=this.query.model.cube.connection+"/"+this.query.model.cube.catalog+"/"+(""===c||null===c?"null":c)+"/"+encodeURIComponent(this.query.model.cube.name),
...
b);_.bindAll(this,"run");this.uuid="xxxxxxxx-xxxx-xxxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"==a?b:b&3|8).toString(16)}).toUpperCase();this.model=_.extend({name:this.uuid},SaikuOlapQueryTemplate);a.cube&&(this.model.cube=a.cube);this.helper=new SaikuOlapQueryHelper(this);this.action=new QueryAction({},{query:this});this.result=new Result({limit:Settings.RESULT_LIMIT},{query:this});this.scenario=new QueryScenario({},{query:this});this.updatedSelectionFromModal=
!1},parse:function(a){this.id=this.uuid;a.name&&(this.uuid=this.id=a.name);this.model=_.extend(this.model,a);this.model.properties=_.extend({},Settings.QUERY_PROPERTIES,this.model.properties)},setProperty:function(a,b){this.model.properties[a]=b},getProperty:function(a){return this.model.properties[a]},syncSelectionsModalAndUpdateParameters:function(){if(this.updatedSelectionFromModal){var a=this.helper.model().parameters,b;for(b in a){var c=a[b],d=this.helper.getSelectionsForParameter(b),c=d.map(function(a){return a.caption}).join();
a[b]=c}}else for(b in a=this.helper.model().parameters,a)c=a[b],this.helper.getLevelForParameter(b),d=this.helper.getSelectionsForParameter(b),null!==c&&void 0!==c&&this.helper.setSelectionsForParameter(b,_.filter(d,function(a){var b=!1;_.each(c.split(","),function(c){if(a.caption===c)return b=!0,!1});return b}));this.updatedSelectionFromModal=!1},run:function(a,b){this.syncSelectionsModalAndUpdateParameters();var c=this;Saiku.ui.unblock();if("undefined"==typeof this.model.properties||!1!==this.model.properties["saiku.olap.query.automatic_execution"]||
!1!==a&&void 0!==a&&null!==a){this.workspace.unblock();$(this.workspace.el).find(".workspace_results_info").empty();this.workspace.trigger("query:run");this.result.result=null;var d=!1,e='\x3cspan class\x3d"i18n"\x3eQuery Validation failed!\x3c/span\x3e',f=this.helper.model(),h;for(h in this.attributes){var k=this.attributes[h];if("PARAM"===h.substring(0,5)){var l=h.substring(5,h.length);f.parameters[l]=k}}"OLAP"==f.queryType&&("QUERYMODEL"==f.type?(h=0<Object.keys(f.queryModel.axes.COLUMNS.hierarchies).length,
k=0<Object.keys(f.queryModel.axes.ROWS.hierarchies).length,l="COLUMNS"==f.queryModel.details.axis&&0<f.queryModel.details.measures.length,k&&h&&l||(e=""),h||l||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one measure or a level on columns for a valid query.\x3c/span\x3e'),k||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one level on rows for a valid query.\x3c/span\x3e'),(h||l)&&k&&(d=!0)):"MDX"==f.type&&((d=f.mdx&&0<f.mdx.length)||(e='\x3cspan class\x3d"i18n"\x3eYou need to enter some MDX statement to execute.\x3c/span\x3e')));
...
this;this.workspace.query.action.post("/../enrich",{contentType:"application/json",data:JSON.stringify(a.model),async:!1,success:function(b,c){a.model=c}})},url:function(){return"api/query/"+encodeURI(this.uuid)}}),Session=Backbone.Model.extend({username:null,password:null,sessionid:null,upgradeTimeout:null,isAdmin:!1,id:null,atemptedToLoginByCookie:!1,initialize:function(a,b){_.extend(this,Backbone.Events);_.bindAll(this,"check_session","process_session","load_session","login","brute_force");b&&
b.username&&b.password?(this.username=b.username,this.password=b.password,Settings.DEMO?this.check_session():this.save({username:this.username,password:this.password},{success:this.check_session,error:this.check_session})):this.check_session()},check_session:function(){var a=this.getCookie(Settings.ORBIS_AUTH.cookieName);Settings.ORBIS_AUTH.enabled&&a&&!this.atemptedToLoginByCookie?(this.atemptedToLoginByCookie=!0,this.login("orbis","orbis")):null===this.sessionid||null===this.username||null===this.password?
...
this.setupPage(this),$("#splash \x3e nav \x3e ul \x3e li.active \x3e a").click(function(){var a=$(this).attr("class");$("nav li").removeClass("active");$(this).parent().addClass("active");$(".stabs section").hide();$("#"+a).fadeIn()}));return this},remove:function(){$(this.el).remove()},caption:function(a){return'\x3cspan class\x3d"i18n"\x3eHome\x3c/span\x3e'},getNews:function(){},getContent:function(){var a=this;new License;$.ajax({type:"GET",url:"http://meteorite.bi/content.json",async:!1,contentType:"application/json",
dataType:"jsonp",jsonpCallback:"jsonCallback2",cache:!0,success:function(b){$(a.el).find("#dyn_content").html(b.item[0].content);$(a.el).find(".responsive-container").fitVids();$(self.el).html(a.template());"trial"!=Settings.LICENSE.licenseType&&"Open Source License"!=Settings.LICENSE.licenseType&&$(self.el).find(".enterprisetoggle").css("visibility","hidden")},error:function(a){$(self.el).html(self.template());"trial"!=Settings.LICENSE.licenseType&&"Open Source License"!=Settings.LICENSE.licenseType&&
$(self.el).find(".enterprisetoggle").css("visibility","hidden")}})}}),SessionWorkspace=Backbone.Model.extend({initialize:function(a,b){_.extend(this,Backbone.Events);_.bindAll(this,"process_datasources","prefetch_dimensions");this.initialized=!1;this.first=!0;"undefined"!==typeof localStorage&&localStorage&&(Settings.LOCALSTORAGE_EXPIRATION&&0!==Settings.LOCALSTORAGE_EXPIRATION||localStorage.clear(),localStorage.getItem("expiration")&&localStorage.getItem("expiration")<=(new Date).getTime()?localStorage.clear():
localStorage.getItem("saiku-version")&&localStorage.getItem("saiku-version")===Settings.VERSION||(localStorage.clear(),localStorage.setItem("saiku-version",Settings.VERSION)));Saiku.ui.block("Loading datasources....");this.fetch({success:this.process_datasources},{})},refresh:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();this.clear();"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("saiku-version",Settings.VERSION);this.fetch({success:this.process_datasources},
{})},destroy:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();return!1},render_default_tab:function(a,b){null!=b&&b.unbind("report:rendered");for(var c=this,d=0;d<a.length;d++)if(a[0].visible){filePath=a[0].path;if(filePath.indexOf(".saiku")===filePath.length-6){Saiku.ui.block("Loading default report...");fileName=filePath.replace(/^.*[\\\/]/,"");var e=new SavedQuery({file:filePath,name:fileName}),d={fileType:"saiku",name:fileName.split(".saiku")[0]},f=_.extend({file:e.get("file"),
formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS),e=new Query(f,{name:e.get("name")}),d=new Workspace({query:e,item:d,viewState:null});Saiku.tabs.add(d);a.shift();d.bind("report:rendered",function(){c.render_default_tab(a)})}else filePath.indexOf(".sdb")===filePath.length-4&&(Saiku.Dashboards?(Saiku.ui.block("Loading default report..."),Saiku.tabs.add(new DashboardViewTab({file:a[d].path}))):!Settings.INITIAL_QUERY&&paramsURI.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace));
break}else a.shift()},process_datasources:function(a,b){if("undefined"!==typeof localStorage&&localStorage&&null===localStorage.getItem("session")){localStorage.setItem("session",JSON.stringify(b));var c=(new Date).getTime()+Settings.LOCALSTORAGE_EXPIRATION;"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("expiration",c)}this.cube_navigation=_.template($("#template-cubes").html())({connections:b});this.cube={};this.connections=b;_.delay(this.prefetch_dimensions,20);if(this.initialized)Settings.INITIAL_QUERY||
...
if(a.indexOf(".saiku")===a.length-6){Saiku.ui.block("Loading default report...");b=a.replace(/^.*[\\\/]/,"");a=new SavedQuery({file:a,name:b});b={fileType:"saiku",name:b.split(".saiku")[0]};var c=_.extend({file:a.get("file"),formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS);a=new Query(c,{name:a.get("name")});var e=new Workspace({query:a,item:b,viewState:null});Saiku.tabs.add(e);l.shift();e.bind("report:rendered",function(){k.render_default_tab(l,e)})}else a.indexOf(".sdb")===a.length-4&&(Saiku.Dashboards?
(Saiku.ui.block("Loading default report..."),Saiku.tabs.add(new DashboardViewTab({file:l[b].path})),l.shift(),k.render_default_tab(l,null)):!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace));break}else l.shift();else!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace)};!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace);
var c=Settings.DEFAULT_REPORTS._,f=[];_.each(Saiku.session.roles,function(a){a=Settings.DEFAULT_REPORTS[a];void 0!=a&&0<a.length&&(f=f.concat(a))});var h=0,k=this,l=c.concat(Settings.DEFAULT_REPORTS[Saiku.session.username]).concat(f),h=setInterval(function(){console.log("window.DashboardViewTab",window.DashboardViewTab);console.log("typeof window.DashboardViewTab",typeof window.DashboardViewTab);void 0===Saiku.Dashboards?(clearInterval(h),e()):"undefined"!==typeof window.DashboardViewTab&&(clearInterval(h),
e())},100)}else!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace)}},prefetch_dimensions:function(){for(var a=0,b=this.connections.length;a<b;a++)for(var c=this.connections[a],d=0,e=c.catalogs.length;d<e;d++)for(var f=c.catalogs[d],h=0,k=f.schemas.length;h<k;h++)for(var l=f.schemas[h],g=0,m=l.cubes.length;g<m;g++){var n=c.name+"/"+f.name+"/"+(""===l.name||null===l.name?"null":l.name)+"/"+encodeURIComponent(l.cubes[g].name);"undefined"!==
typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+n)?this.cube[n]=new Cube(JSON.parse(localStorage.getItem("cube."+n))):(this.cube[n]=new Cube({key:n}),!0===Settings.DIMENSION_PREFETCH&&this.cube[n].fetch())}!this.initialized&&Backbone.history&&(Backbone.history.start(),this.initialized=!0)},url:function(){return this.first?(this.first=!1,encodeURI(Saiku.session.username+"/discover")):encodeURI(Saiku.session.username+"/discover/refresh")}}),Member=Backbone.Model.extend({initialize:function(a,
b){this.cube=b.cube;var c=b.dimension.split("/");this.hierarchy=decodeURIComponent(c[0]);this.level=decodeURIComponent(c[1])},url:function(){return encodeURI(Saiku.session.username+"/discover/")+this.cube+"/hierarchies/"+encodeURIComponent(this.hierarchy)+"/levels/"+encodeURIComponent(this.level)}}),Plugin=Backbone.Model.extend({}),PluginCollection=Backbone.Collection.extend({model:Plugin,url:"info"}),SettingsOverride=Backbone.Model.extend({}),SettingsOverrideCollection=Backbone.Collection.extend({model:SettingsOverride,
url:"info/ui-settings"}),License=Backbone.Model.extend({url:"api/license",initialize:function(){_.bindAll(this,"fetch_license")},fetch_license:function(a,b){this.fetch({success:function(a){b&&"function"===typeof b&&b({status:"success",data:a})},error:function(a){b&&"function"===typeof b&&b({status:"error",data:a})}})}}),LicenseUserModel=Backbone.Model.extend({url:"api/license/users"}),LicenseUsersCollection=Backbone.Collection.extend({url:"api/license/users",model:LicenseUserModel}),LicenseQuota=
Backbone.Model.extend({url:"api/license/quota",initialize:function(){_.bindAll(this,"fetch_quota")},fetch_quota:function(a,b){this.fetch({success:function(a){b&&"function"===typeof b&&b({status:"success",data:a})},error:function(a){b&&"function"===typeof b&&b({status:"error",data:a})}})}}),Saiku={toolbar:{},tabs:new TabSet,introDone:!1,splash:new SplashScreen({toolbar:this.toolbar}),session:null,events:_.extend({},Backbone.Events),routers:[],leaflet:"undefined"!==typeof L?L:{},ui:{block:function(a){$(".processing_message").html(a);
$(".processing_message").removeClass("i18n_translated").addClass("i18n");Saiku.i18n.translate();$(".processing, .processing_container").show()},unblock:function(){$(".processing, .processing_container, .blockOverlay").hide();$(".blockUI").fadeOut("slow")}},log:function(a,b){console&&console.log&&(console.log("Logging for: "+a),b&&console.log(b))},error:function(a,b){console&&console.error&&(console.error("Logging for: "+a),console.error(b))},URLParams:{buildValue:function(a){return/^\s*$/.test(a)?
null:/^(true|false)$/i.test(a)?"true"===a.toLowerCase():isFinite(a)?parseFloat(a):a},joinArrayValues:function(a){return 2===a.length?a[1]:a[1]+"\x3d"+a[2]},paramsURI:function(){var a={},b=window.location.search.substr(1).split("\x26"),c=b.length,d,e;if(1<window.location.search.length)for(d=0;d<c;d++)e=b[d].split("\x3d"),a[decodeURIComponent(e[0])]=1<e.length?this.buildValue(decodeURIComponent(this.joinArrayValues(e))):null;return a},equals:function(){var a=Array.prototype.slice.call(arguments),b=
this.paramsURI();return _.isEqual(b,a[0])?!0:!1},contains:function(){var a=Array.prototype.slice.call(arguments),b=this.paramsURI(),c={},d;for(d in b)b.hasOwnProperty(d)&&a[0][d]&&b[d]===a[0][d]&&(c[d]=a[0][d]);return _.isEqual(c,a[0])?!0:!1}},loadCSS:function(a,b){var c=window.document.createElement("link"),d=window.document.getElementsByTagName("script")[0];c.rel="stylesheet";c.href=a;c.media="only x";d.parentNode.insertBefore(c,d);setTimeout(function(){c.media=b||"all"});return c},loadJS:function(a,
b){var c=window.document.createElement("script"),d=window.document.getElementsByTagName("script")[0];c.src=a;c.async=!0;d.parentNode.insertBefore(c,d);b&&"function"===typeof b&&(c.onload=b);return c},toPattern:function(a,b){for(var c=("object"===typeof b?b.pattern:b).split(""),d=a.toString().replace(/[^0-9a-zA-Z]/g,""),e=0,f=c.length,h=0;h<f&&!(e>=d.length);h++)if("9"===c[h]&&d[e].match(/[0-9]/)||"A"===c[h]&&d[e].match(/[a-zA-Z]/)||"S"===c[h]&&d[e].match(/[0-9a-zA-Z]/))c[h]=d[e++];else if("9"===c[h]||
"A"===c[h]||"S"===c[h])c=c.slice(0,h);return c.join("").substr(0,h)},replaceString:function(a,b,c){for(var d=c.length,e=0;e<d;e++)c.substring(e,e+a.length)===a&&(c=c.substring(0,e)+b+c.substring(e+a.length,c.length));return c},removeBrackets:function(a){return a.toString().replace(/[\[\]]/gi,"")},trimFirstLastChar:function(a,b){var c=a.toString();return"first"===b?c.substring(1,c.length):"last"===b?c.substring(0,c.length-1):c.substring(1,c.length-1)}};
Saiku.singleton=function(){var a;Saiku.singleton=function(){if(a)return a;a=this;this.set=function(a){this.data=a};this.get=function(){return this.data}};return Saiku.singleton}();Backbone.emulateHTTP=!1;
...
var WarningModal=Modal.extend({type:"info",buttons:[{text:"Okay",method:"okay"},{text:"Cancel",method:"close"}],initialize:function(a){this.options.title=a.title;this.message='\x3cspan class\x3d"i18n"\x3e'+a.message+"\x3c/span\x3e";this.cancelfunction=a.cancel;this.okayfunction=a.okay;this.okaycallbackobject=a.okayobj;this.cancelcallbackobject=a.cancelobj},close:function(a){"#close"===a.target.hash&&a.preventDefault();_.isFunction(this.cancelfunction)&&null!=this.cancelfunction&&this.cancelfunction(this.cancelcallbackobject);
this.$el.dialog("close")},okay:function(a){a.preventDefault();_.isFunction(this.okayfunction)&&null!=this.okayfunction&&this.okayfunction(this.okaycallbackobject);this.$el.dialog("close")}}),TitlesModal=Modal.extend({type:"info",buttons:[{text:"Okay",method:"okay"},{text:"Cancel",method:"close"}],message:_.template("\x3cform id\x3d'login_form'\x3e\x3clabel for\x3d'title' class\x3d'i18n'\x3eTitle\x3c/label\x3e\x3cinput type\x3d'text' id\x3d'title' name\x3d'title' value\x3d'' /\x3e\x3clabel for\x3d'variable' class\x3d'i18n'\x3eVariable\x3c/label\x3e\x3cinput type\x3d'text' id\x3d'variable' name\x3d'variable' value\x3d'' /\x3e\x3clabel for\x3d'explanation' class\x3d'i18n'\x3eExplanation\x3c/label\x3e\x3cinput type\x3d'text' id\x3d'explanation' name\x3d'explanation' value\x3d'' /\x3e\x3c/form\x3e")(),
